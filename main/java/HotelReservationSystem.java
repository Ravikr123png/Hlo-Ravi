...
public class HotelReservationSystem {
    ...
    private static final String password = "Ravikr@123#";
    ...
    private static void viewReservations(Connection connection) throws SQLException {
        String sql = "SELECT reservation_id, guest_name, room_no, contact_no, reservations_date FROM reservations";
        ...
        try (Statement statement = connection.createStatement();
            ...
            while (resultSet.next()) {
                ...
                String reservationDate = resultSet.getTimestamp("reservations_date").toString();
                if (reservationDate != null) {
                    System.out.println("Timestamp: " + reservationDate);
                } else {
